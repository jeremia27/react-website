...
const Footer = () => {
    return (
        <footer className="footer section__padding bg__grey">
                ...
                <div className="footer__content grid text__light text__center">
                    ...
                    <div className="footer__content--item">
                        ...
                        <ul className="footer__links">
                            ...
                            <li><a rel="noreferrer" target="_blank" href = "https://wa.me/6282167401737">WhatsApp</a></li>
                        </ul>
                        {/* <div className="card bg__dark">
                            <ul className="footer__links">
                                <li>
                                    <a className="socialContainer containerOne" target="_blank" href="https://www.instagram.com/jeremiasbrni/">
                                ...
                                <li>
                                    <a className="socialContainer containerThree" target="_blank" href="https://www.linkedin.com/in/jeremia-sibarani-4a6a5b174/">
                                ...
                                <li>
                                    <a className="socialContainer containerFour" target="_blank" href="https://wa.me/6282167401737">
